...
#ifndef TESTING_APP_FOR_CHALLENGE_2_SWIFT_H
#define TESTING_APP_FOR_CHALLENGE_2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="testing_app_for_challenge_2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
